...
import collections
import six
from pydapaccess.dap_settings import DAPSettings
from pydapaccess.dap_access_api import DAPAccessIntf
from pydapaccess.cmsis_dap_core import CMSISDAPProtocol
from pydapaccess.interface import interface, micropython_backend
from pydapaccess.cmsis_dap_core import (
    Command,
    Pin,
    Capabilities,
    DAPSWOTransport,
...
def _get_interfaces():
    ...
    return [ micropython_backend.Interface ]
    ...
    def get_connected_devices():
        ...
        for interface in all_interfaces:
            try:
                ...
                LOG.error('Failed to get unique id')
        return all_daplinks
    ...
    def _lookup_interface_for_unique_id(unique_id):
        ...
        for interface in all_interfaces:
            try:
                ...
                LOG.error('Failed to get unique id for open')
